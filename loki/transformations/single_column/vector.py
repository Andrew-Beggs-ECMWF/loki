...
__all__ = [
    ...
    'SCCDemoteTransformation', 'SCCRevectorDriverTransformation',
...
class SCCRevectorDriverTransformation(Transformation):
    """
    ...
    def add_vector_index_to_calls(self, routine, targets, add_to_signature=False):
        ...
        for call in FindNodes(ir.CallStatement).visit(routine.body):
            ...
            new_kwargs = (self.horizontal.index, self.horizontal.get_index_variable(routine))
        ...
        if add_to_signature:
            ...
            ivar = self.horizontal.get_index_variable(routine)
